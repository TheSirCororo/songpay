...
object ErrorResponses {
    ...
    val HttpMessageNotReadable: (HttpMessageNotReadableException) -> ErrorResponse = {
        ErrorResponse("Http message is not readable: ${it.message}", 4, 400)
    }
    ...
    val InternalServerError: (Exception?) -> ErrorResponse =
        { ErrorResponse("Internal Server Error: ${it?.stackTraceToString()}", 500) }
}
